...
function loop(){
	...
	ctx.fillStyle = "grey";
	ctx.fillRect(cnv.width / 4 * 3, 550, cnv.width / 4, 30);
	ctx.fillRect(0, 550,cnv.width / 4, 30);
	ctx.fillRect(cnv.width / 12 * 4 , 300, cnv.width / 3, 30)
	...
	//--------------------------RED----------------------------//
	if(redy == 250 && redx > cnv.width / 4){
		if(redy == 250 && redx + 150 < cnv.width / 4 * 3){
		redonground = false; redmoveY = 10;
		}
	}
	if(redy == 0 && redx + 150 < cnv.width / 12 * 4){redonground = false; redmoveY = 10;}
	else if(redy == 0 && redx > cnv.width / 12 * 8){redonground = false; redmoveY = 10;}
	...
	if(redonground == false){
		if(redmoveY < -2){
			...
			if(redy > 250 && redy < 400 && redx < cnv.width / 4) {redonground = true; redy = 250; redjumpcount = 0;}
			if(redy > 250 && redy < 400 && redx + 150 > cnv.width / 4 * 3) {redonground = true; redy = 250; redjumpcount = 0;}	
			if(redy > 0 && redy < 50 && redx + 150 > cnv.width / 12 * 4 && redx < cnv.width / 12 * 8) {redonground = true; redy = 0; redjumpcount = 0;}
			if(redy > 600){redonground = true; redy = 600; redjumpcount = 0;}
		}
	...
	//------------------------------BLUE------------------------------//
	if(bluey == 250 && bluex > cnv.width / 4){
		if(bluey == 250 && bluex + 150 < cnv.width / 4 * 3){
		blueonground = false; bluemoveY = 10;
		}
	}
	if(bluey == 0 && bluex + 150 < cnv.width / 12 * 4){blueonground = false; bluemoveY = 10;}
	else if(bluey == 0 && bluex > cnv.width / 12 * 8){blueonground = false; bluemoveY = 10;}
	...
	if(blueonground == false){
		if(bluemoveY < -2){
			...
			if(bluey > 250 && bluey < 400 && bluex < cnv.width / 4) {blueonground = true; bluey = 250; bluejumpcount = 0;}
			if(bluey > 250 && bluey < 400 && bluex + 150 > cnv.width / 4 * 3) {blueonground = true; bluey = 250; bluejumpcount = 0;}			
			if(bluey > 0 && bluey < 50 && bluex + 150 > cnv.width / 12 * 4 && bluex < cnv.width / 12 * 8) {blueonground = true; bluey = 0; bluejumpcount = 0;}
			if(bluey > 600){blueonground = true; bluey = 600; bluejumpcount = 0;}
		}
