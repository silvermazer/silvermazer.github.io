...
function loop(){
	...
	ctx.fillStyle = "grey";
	ctx.fillRect(cnv.width / 4, 550, cnv.width / 2, 30);
	...
	//--------------------------RED----------------------------//
	if(redy == 250 && redx + 150 < cnv.width / 4){redonground = false; redmoveY = 10;}
	else if(redy == 250 && redx > cnv.width / 4 * 3){redonground = false; redmoveY = 10;}
	...
	if(redonground == false){
		if(redmoveY < -2){
			...
			if(redy > 250 && redy < 400 && redx + 150 > cnv.width / 4 && redx < cnv.width / 4 * 3) {redonground = true; redy = 250; redjumpcount = 0;}			
	...
	//------------------------------BLUE------------------------------//
	if(bluey == 250 && bluex + 150 < cnv.width / 4){blueonground = false; bluemoveY = 10;}
	else if(bluey == 250 && bluex > cnv.width / 4 * 3){blueonground = false; bluemoveY = 10;}
	...
	if(blueonground == false){
		if(bluemoveY < -2){
			...
			if(bluey > 250 && bluey < 400 && bluex + 150 > cnv.width / 4 && bluex < cnv.width / 4 * 3) {blueonground = true; bluey = 250; bluejumpcount = 0;}	
